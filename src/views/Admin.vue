    ...
    <div style="padding: 10px">
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="registerPlace" label="注册地址" align="center"></el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-form-item label="地址">
                    <el-input v-model="form.registerPlace"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    export default {
        ...
        methods: {
            getUsers() {
                this.$http.get('http://localhost:8080/user/all').then(res => {
